/*
Updated Sales Gross Margin Query
...
WITH BASE AS (
	...
	(case  
       ...
       (case  
		...
		INNER JOIN InvcHead ON InvcDtl.InvoiceNum = InvcHead.InvoiceNum
		WHERE InvcHead.InvoiceDate >= convert(date, '20250601', 112) and InvcHead.InvoiceDate < convert(date, '20250701', 112)
...
where InvcHead.Company = 'AU6101'  and InvcHead.Posted = 1  and InvcHead.UnappliedCash = 0  and InvcHead.StartUp = 0  and (InvcHead.InvoiceType = 'SHP'  or InvcHead.InvoiceType = 'MIS' ) and InvcHead.DebitNote = 0 
