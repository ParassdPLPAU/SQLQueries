...
SELECT OrderRel.Company,OrderNum,OrderLine,OrderRelNum,OrderRel.PartNum,OpenRelease,VoidRelease,1 as 'VoidRelease' FROM OrderRel INNER JOIN PartPlant on 
